 ...
 * 
 * Modification to add multiple colors for Objective-C syntax highlighting
 * Author: Jaminyah
 * Date: February 14, 2013
 * Notes: Modified lines 89 - 98
 */
;(function()
{
	// CommonJS
	...
	function Brush()
	{
		...
		var keywords =	'break case catch class copy const __finally __exception __try ' +
						...
						'setter sizeof static static_cast strong struct super switch template this ' +
		...
		this.regexList = [
			...
			{ regex: new RegExp('#\\w+\\b', 'gm'),						css: 'preprocessor' },      // #import
			{ regex: new RegExp('\\w+\\/\\w+\\.h\\b', 'gm'),			css: 'system bold' },       // system libs
			{ regex: new RegExp('"\\w+\\.h"\\b', 'gm'),					css: 'user bold' },         // user libs
			{ regex: new RegExp(this.getKeywords(datatypes), 'gm'),		css: 'keyword bold' },
			{ regex: new RegExp(this.getKeywords(functions), 'gm'),		css: 'functions bold' },
			{ regex: new RegExp(this.getKeywords(keywords), 'gm'),		css: 'keyword bold' },
			{ regex: new RegExp('\\bNS\\w+\\b', 'gm'),					css: 'uikit bold' },
			{ regex: new RegExp('\\bUI\\w+\\b', 'gm'),					css: 'uikit bold' },
			{ regex: new RegExp('\\bIB\\w+\\b', 'gm'),					css: 'uikit bold' },
